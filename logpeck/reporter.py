            ...
            <div class="card" style="margin-top:2rem">
                ...
                <table style="margin-top:1.5rem; width:100%; table-layout: auto">
                    ...
                    <tbody>
                        ...
                        <tr><td style="font-weight:700">Impact<br><span style="color:var(--text-secondary);font-weight:normal;font-size:0.85rem">(%)</span></td><td><strong style="color:var(--text-primary)">Relative Latency Weight.</strong> Derived as <code style="font-family:'JetBrains Mono', monospace;background:rgba(0,0,0,0.2);padding:0.2rem 0.4rem;border-radius:4px">(Shape Latency / Total Slow Latency) * 100</code>.<br><span style="color:var(--text-secondary);font-size:0.85rem;display:block;margin-top:0.6rem">Helps with surgical prioritization. Higher % = the query is a dominant contributor to the overall slowness.</span></td></tr>
                    </tbody>
                </table>
            </div>
