...
- **High-Precision Search (`--grep`)**: A stateless, full-text match. Mimics standard `grep` speed and behavior by searching the entire raw JSON string of the log entry.
